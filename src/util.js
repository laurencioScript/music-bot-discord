...
exports.displayDevTeam = (message) => {
...
exports.displayHelpActions = (message) => {
  const embed = new MessageEmbed()
      .setTitle('Comandos')
      .setColor('#0099ff')
...
exports.displayGbmInfo = (message) => {
...
exports.displayTeamBirthday = (message) => {
